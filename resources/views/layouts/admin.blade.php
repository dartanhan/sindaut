    ...
    <aside id="admin-sidebar"
        ...
        <nav class="flex-1 px-4 py-2 space-y-2 overflow-y-auto no-scrollbar lg:px-3 lg:group-hover:px-4 transition-all duration-300">
            ...
            <a href="{{ route('quemsomos.index') }}"
                class="flex items-center gap-4 lg:gap-0 lg:group-hover:gap-4 px-6 py-4 lg:px-4 lg:group-hover:px-6 rounded-2xl transition-all duration-300 {{ request()->routeIs('quemsomos.*') ? 'bg-blue-600 text-white font-bold shadow-lg shadow-blue-600/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                <i data-lucide="info" class="w-5 h-5 flex-shrink-0"></i>
                <span class="transition-all duration-300 lg:opacity-0 lg:group-hover:opacity-100 lg:w-0 lg:group-hover:w-auto whitespace-nowrap overflow-hidden">Quem Somos</span>
            </a>
            ...
            <!-- Cards da Home -->
            <a href="{{ route('home-card.index') }}"
                class="flex items-center gap-4 lg:gap-0 lg:group-hover:gap-4 px-6 py-4 lg:px-4 lg:group-hover:px-6 rounded-2xl transition-all duration-300 {{ request()->routeIs('home-card.*') ? 'bg-blue-600 text-white font-bold shadow-lg shadow-blue-600/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                <i data-lucide="layout-grid" class="w-5 h-5 flex-shrink-0"></i>
                <span class="transition-all duration-300 lg:opacity-0 lg:group-hover:opacity-100 lg:w-0 lg:group-hover:w-auto whitespace-nowrap overflow-hidden">Cards da Home</span>
            </a>
