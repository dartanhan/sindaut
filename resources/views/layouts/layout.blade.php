...
<head>
    ...
    <style>
        ...
        /* Footer mobile responsiveness, font sizes, and height reduction */
        @media (max-width: 767px) {
            ...
            /* If there are more columns, they will wrap to next line and take full width */
        ...
        /* Footer desktop spacing adjustments */
...
<div class="container">
    ...
    <footer id="footer" style="background:#111827; color:#e5e7eb; margin-top:0; padding:0;">
        ...
        {{-- Footer Body --}}
        <div class="footer-body" style="padding: 36px 0 24px;">
            <div class="row footer-row" style="margin:0 15px; align-items:flex-start;">

                {{-- Logo --}}
                <div class="col-lg-2 col-md-3 col-sm-12 footer-col footer-col-logo" style="margin-bottom:20px; padding-right:20px;">
                ...
                {{-- Fale Conosco --}}
                @if($temFale)
                <div class="col-lg-3 col-md-3 col-sm-12 footer-col footer-col-content" style="margin-bottom:20px; padding-right:20px; border-right:1px solid #1f2937;">
                    <p class="footer-title" style="font-size:9px; font-weight:800; letter-spacing:.18em; text-transform:uppercase; color:#4b5563; margin-bottom:12px;">FALE CONOSCO</p>
                    @foreach($faleConosco as $setor)
                        @if(!empty($setor['setor']) || !empty($setor['telefone']))
                        <div class="footer-info-item" style="display:flex; align-items:baseline; gap:5px; margin-bottom:6px; flex-wrap:wrap;">
                ...
                {{-- Sede --}}
                @if($temSede)
                <div class="col-lg-3 col-md-3 col-sm-12 footer-col footer-col-content" style="margin-bottom:20px; padding-right:20px; {{ $temSubsede ? 'border-right:1px solid #1f2937;' : '' }}">
                    <p class="footer-title" style="font-size:9px; font-weight:800; letter-spacing:.18em; text-transform:uppercase; color:#4b5563; margin-bottom:12px;">ATENDIMENTO</p>
                    @if($footerConfig->sede_telefone)
                        <div class="footer-info-item" style="display:flex; align-items:flex-start; gap:8px; margin-bottom:8px;">
                ...
                {{-- Subsede --}}
                @if($temSubsede)
                <div class="col-lg-3 col-md-3 col-sm-12 footer-col footer-col-content" style="margin-bottom:20px;">
                    <p class="footer-title" style="font-size:9px; font-weight:800; letter-spacing:.18em; text-transform:uppercase; color:#4b5563; margin-bottom:12px;">SUBSEDE</p>
        ...
        {{-- Copyright bar --}}
        <div class="copyright-bar" style="border-top:1px solid #1f2937; padding:12px 30px; text-align:center;">
