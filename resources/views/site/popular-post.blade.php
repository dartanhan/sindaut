    ...
    <ul class="spost_nav">
        <li>
            <div class="media wow fadeInDown">
                <a href="{{URL::asset('storage/posts/files/658767de4359d6772fbc14b6291c2d7a.pdf')}}" target="_blank" class="media-left">
                    <img alt="" src="{{URL::asset('images/jornal.png')}}"> </a>
                <div class="media-body">
                    <a href="{{URL::asset('storage/posts/files/658767de4359d6772fbc14b6291c2d7a.pdf')}}" target="_blank"  class="catg_title"> JORNAL DO SINDAUT 47</a>
                </div>
            </div>
        </li>
        <div class="media wow fadeInDown">
