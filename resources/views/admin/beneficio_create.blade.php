...
@section('header_title', 'Novo Benefício')
@section('header_subtitle', 'Crie um novo benefício para os associados')
...
<div class="flex gap-4">
    ...
    <button form="beneficioForm" type="submit" id="btnSubmit" class="bg-blue-600 hover:bg-slate-900 text-white font-black px-8 py-3 rounded-2xl transition shadow-xl shadow-blue-600/20 text-sm flex items-center gap-2">
        <span id="btnText">SALVAR BENEFÍCIO</span>
...
<div class="max-w-5xl mx-auto">
    ...
    <form id="beneficioForm" action="{{ route('beneficio.store') }}" method="POST" class="space-y-8 pb-20">
        @csrf
