...
@section('title', 'Nova História')
@section('header_title', 'Nova História')
@section('header_subtitle', 'Crie um novo registro de história para o sindicato')
...
<div class="flex gap-4">
    ...
    <button form="historiaForm" type="submit" id="btnSubmit" class="bg-blue-600 hover:bg-slate-900 text-white font-black px-8 py-3 rounded-2xl transition shadow-xl shadow-blue-600/20 text-sm flex items-center gap-2">
        <span id="btnText">SALVAR HISTÓRIA</span>
...
<div class="max-w-5xl mx-auto">
    ...
    <form id="historiaForm" action="{{ route('historia.store') }}" method="POST" class="space-y-8 pb-20">
        @csrf
