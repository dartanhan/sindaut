...
@section('title', 'Gerenciar Departamento Jurídico')
...
<a href="{{ route('depjuridico.create') }}" class="bg-blue-600 hover:bg-slate-900 text-white font-black px-8 py-3 rounded-2xl transition flex items-center gap-2 text-sm shadow-xl shadow-blue-600/20">
...
<div class="space-y-8">
    ...
    <div class="bg-white rounded-[2rem] shadow-sm border border-slate-100 overflow-hidden">
        <div class="p-8 border-b border-slate-100 flex items-center justify-between">
            ...
            <span class="text-xs font-black text-slate-400 uppercase tracking-widest">{{ count($depjuridicos) }} cadastrados</span>
        </div>
                        ...
                        <tr class="hover:bg-slate-100/50 transition">
                            ...
                            <td class="p-6">
                                <div class="flex items-center justify-end gap-3">
                                    <a href="{{ route('depjuridico.edit', $item->id) }}" class="w-10 h-10 bg-white border border-slate-100 text-slate-400 rounded-xl flex items-center justify-center hover:bg-blue-600 hover:text-white hover:border-blue-600 transition shadow-sm">
                                    ...
                                    <button type="button" 
                                            ...
                                            data-rota="{{ route('depjuridico.destroy', $item->id) }}">
